...
class ChatTemplateStrategy(PromptTokenizingStrategy):
    ...
    def __init__(
        ...
        if cfg and cfg.get("enable_channel_loss"):
            ...
            LOG.info(
                f"ChatTemplateStrategy: Using channel field '{self.channel_loss_field}' for Channel Loss"
            )
    ...
    def _tokenize_single_prompt(self, prompt: dict) -> Dict[str, List[int]]:
        ...
        if (
            ...
            if self.channel_loss_field and self.channel_loss_field in prompt:
                tokenized_prompt[self.channel_loss_field] = prompt[
                    self.channel_loss_field
                ]
