---
name: create-pr
description: Rebase from the latest origin/main, squash commits, and create a PR with intelligent messages.. Use when the user asks for this Codex workflow or names this skill.
---
