---
name: gen-commit-msg
description: Generate intelligent commit messages based on staged changes.. Use when the user asks for this Codex workflow or names this skill.
---
...
Commit messages should follow the repository Lore Commit Protocol when creating an actual commit.
