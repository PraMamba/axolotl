...
## CRITICAL Level (Must use high-reasoning Codex agent)
...
## HIGH Level (Recommend high-reasoning Codex agent)
...
## MEDIUM Level (Use standard-reasoning Codex agent)
...
## LOW Level (Use fast Codex agent)
...
## Core Framework Paths (Must Use high-reasoning Codex agent)
